...
class RedisSessionStore(SessionStore):
    def __init__(self, redis, salt, *args, **kwargs):
        ...
        self.normal_session_store = werkzeug.contrib.sessions.FilesystemSessionStore(self.path, session_class=OpenERPSession)
    ...
    def save(self, session):
        ...
        try:
            return self.redis.set(key, data, ex=STATIC_CACHE)
    ...
    def get(self, sid):
        ...
        try:
            if self.redis:
                ...
                self.redis.expire(key, STATIC_CACHE)
